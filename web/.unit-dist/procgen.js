import { CHALLENGE_LEVEL_SCALE_UP_FACTOR, CREATURE_BASE_CON, CREATURE_BASE_DEX, CREATURE_BASE_DEFENSE_BONUS, CREATURE_BASE_ATTACK_BONUS, CREATURE_BASELINE_CON, CREATURE_BASELINE_DEX, CREATURE_BASELINE_STR, CREATURE_BASE_STR, CREATURE_MAX_DAMAGE_AT_LEVEL_1, CREATURE_MAX_HP_AT_LEVEL_1, CREATURE_MIN_HP_AT_LEVEL_1, ITEM_ARMOR_DEFENSE_BASE_MIN, ITEM_ARMOR_DEFENSE_CHALLENGE_BONUS, ITEM_WEAPON_FLAT_BONUS_BASE, ITEM_WEAPON_FLAT_BONUS_CHALLENGE_DIVISOR, ITEM_WEAPON_FLAT_BONUS_RANDOM_MAX, NAME_GENERATION_FALLBACK_MAX_ID, NAME_GENERATION_MAX_ATTEMPTS, PLAYER_CRIT_MAXIMUM_MULTIPLIER, PLAYER_CRIT_MINIMUM_ROLL, WEAPON_CRIT_MAXIMUM_ROLL, WEAPON_DAMAGE_FACE_MAX, WEAPON_DAMAGE_FACE_MIN, } from "./constants";
...
export function createWeapon(name, maxDamage, challengeLevel, rng) {
    ...
    const flatBonus = Math.max(ITEM_WEAPON_FLAT_BONUS_BASE, ITEM_WEAPON_FLAT_BONUS_BASE
...
export function createArmor(name, slot, challengeLevel, rng) {
    return new Armor(slot, name, challengeLevel, rng.int(ITEM_ARMOR_DEFENSE_BASE_MIN, challengeLevel + ITEM_ARMOR_DEFENSE_CHALLENGE_BONUS));
}
export function creatureAtLevel(challengeLevel, names, rng) {
    ...
    const creature = new Creature("Goblin", { x: 0, y: 0 }, new AttributeSet({
