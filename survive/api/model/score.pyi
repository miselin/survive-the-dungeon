...
class Score(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["at", "player", "score", "seed", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["at", "player", "score", "seed", ], str]):
